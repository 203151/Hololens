...
public class CardManager : MonoBehaviour {
    ...
    public Transform cardDimentions;
    ...
    public void PlayCard(GameObject gameObject)
    {
        ...
        gameObject.transform.position = new Vector3(BoardCoordinates.x - 0.1F + ( Table.Length * (cardDimentions.localScale.x + 0.015F) ), BoardCoordinates.y, BoardCoordinates.z - 0.02F);
    ...
    public void VilgeEnemyPlayCardFromDeck(int i)
    {
        ...
        EnemyDeck[EnemyDeckSize - 1 - i].transform.position = new Vector3(BoardCoordinates.x - 0.1F + ( ( EnemyTable.Length + i ) * ( cardDimentions.localScale.x + 0.015F ) ), BoardCoordinates.y, BoardCoordinates.z + 0.14F);
    ...
    public void VilgePlayCardFromDeck(int i)
    {
        ...
        Deck[DeckSize - 1 - i].transform.position = new Vector3(-2 + ( ( Table.Length + i ) * ( cardDimentions.localScale.x + 0.015F ) ), -2.95F, 4);
    ...
    public void EnemyPlayCardFromDeck(int i)
    {
        ...
        EnemyDeck[EnemyDeckSize - 1 - i].transform.tag = "EnemyTable";
        SetLayerRecursively(EnemyDeck[EnemyDeckSize - 1 - i], 10);
        EnemyDeck[EnemyDeckSize - 1 - i].transform.position = new Vector3(-2 + ( (EnemyTable.Length + i + 1) * ( cardDimentions.localScale.x + 0.015F ) ), -2.95F, 6);
        EnemyDeck[EnemyDeckSize - 1 - i].transform.rotation = Quaternion.Euler(0, 0, 0);
    }
    ...
    public void PlayCardFromDeck(int i)
    {
        ...
        Deck[DeckSize - 1 - i].transform.tag = "Table";
        SetLayerRecursively(Deck[DeckSize - 1 - i], 11);
        Deck[DeckSize - 1 - i].transform.position = new Vector3(BoardCoordinates.x - 0.1F + ( ( Table.Length + i + 1 ) * ( cardDimentions.localScale.x + 0.015F ) ), BoardCoordinates.y, BoardCoordinates.z - 0.02F);
        Deck[DeckSize - 1 - i].transform.rotation = Quaternion.Euler(0, 0, 0);
    }
    ...
    public void EnemyPlayCard()
    {
        if(NumberOfPlayedCards == 1)
        {
            ...
            EnemyMoveHand(2);
            EnemyHand[2].transform.position = new Vector3(-2 + ( EnemyTable.Length * ( cardDimentions.localScale.x + 0.015F ) ), -2.95F, 6); 
        ...
        else if(NumberOfPlayedCards == 2)
        {
            ...
            EnemyMoveHand(1);
            EnemyHand[1].transform.position = new Vector3(-2 + ( EnemyTable.Length * ( cardDimentions.localScale.x + 0.015F ) ), -2.95F, 6);
        ...
        else if (NumberOfPlayedCards == 3)
        {
            ...
            EnemyMoveHand(5);
            EnemyHand[5].transform.position = new Vector3(-2 + ( EnemyTable.Length * ( cardDimentions.localScale.x + 0.015F ) ), -2.95F, 6);
        ...
        else if (NumberOfPlayedCards == 4)
        {
            ...
            EnemyMoveHand(4);
            EnemyHand[4].transform.position = new Vector3(-2 + ( EnemyTable.Length * ( cardDimentions.localScale.x + 0.015F ) ), -2.95F, 6);
    ...
    public void AlbraichDrawCard()
    {
        ...
        Deck[DeckSize - 1].transform.position = new Vector3(-3 + ( (Hand.Length - 1) * ( cardDimentions.localScale.x + 0.015F ) ) , 0, -0.75F);
    ...
    public void AlbraichEnemyDrawCard()
    {
        ...
        EnemyDeck[EnemyDeckSize - 1].transform.position = new Vector3(EnemyHandCoordinates.x + ((EnemyHand.Length - 1) * ( cardDimentions.localScale.x + 0.015F ) ) , EnemyHandCoordinates.y, EnemyHandCoordinates.z);
    ...
    public void DrawCard (int i)
    {
        ...
        Deck[DeckSize - 1 - i].transform.position = new Vector3(HandCoordinates.x + ((Hand.Length + i) * ( cardDimentions.localScale.x + 0.015F ) ) , HandCoordinates.y, HandCoordinates.z );
    ...
    public void EnemyDrawCard(int i)
    {
        ...
        EnemyDeck[EnemyDeckSize - 1 - i].transform.position = new Vector3(EnemyHandCoordinates.x + ((EnemyHand.Length + i) * ( cardDimentions.localScale.x + 0.015F ) ), EnemyHandCoordinates.y, EnemyHandCoordinates.z );
    ...
    void MoveHand()
    {
        ...
        for ( int i = 0; i < HandSize; i++ )
        {
            ...
            {
                Hand[i].transform.position = new Vector3(Hand[i].transform.position.x - ( cardDimentions.localScale.x + 0.015F ), Hand[i].transform.position.y, Hand[i].transform.position.z); 
            }
    ...
    void EnemyMoveHand(int j)
    {
        for ( int i = 0; i < EnemyHandSize; i++ )
        {
            ...
            {
                EnemyHand[i].transform.position = new Vector3(EnemyHand[i].transform.position.x - ( cardDimentions.localScale.x + 0.015F ), EnemyHand[i].transform.position.y, EnemyHand[i].transform.position.z);
            }
